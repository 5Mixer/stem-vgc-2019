...
kha_Image.create = function(width,height,format,usage,levels) {
	...
	if(kha_SystemImpl.gl == null) {
		...
		return new kha_WebGLImage(width,height,format,false);
	}
};
kha_Image.createRenderTarget = function(width,height,format,depthStencil,antiAliasingSamples) {
	...
	if(kha_SystemImpl.gl == null) {
		...
		return new kha_WebGLImage(width,height,format,true);
	}
};
...
kha_Image.get_maxSize = function() {
	if(kha_SystemImpl.gl == null) {
		...
		return kha_SystemImpl.gl.getParameter(kha_SystemImpl.gl.MAX_TEXTURE_SIZE);
	}
};
...
kha_CanvasImage.prototype = $extend(kha_Image.prototype,{
	...
	,createTexture: function() {
		...
		if(this.renderTarget) {
			...
			kha_SystemImpl.gl.texImage2D(kha_SystemImpl.gl.TEXTURE_2D,0,kha_SystemImpl.gl.RGBA,kha_SystemImpl.gl.RGBA,kha_SystemImpl.gl.UNSIGNED_BYTE,this.video);
		} else {
			kha_SystemImpl.gl.texImage2D(kha_SystemImpl.gl.TEXTURE_2D,0,kha_SystemImpl.gl.RGBA,kha_SystemImpl.gl.RGBA,kha_SystemImpl.gl.UNSIGNED_BYTE,this.image);
		}
...
kha_SystemImpl.loadFinished = function() {
	...
	try {
		...
		haxe_Log.trace(e,{ fileName : "SystemImpl.hx", lineNumber : 195, className : "kha.SystemImpl", methodName : "loadFinished"});
	}
	...
	if(canvas.onwheel) {
		canvas.onwheel = kha_SystemImpl.mouseWheel;
	} else if(canvas.onmousewheel) {
		canvas.onmousewheel = kha_SystemImpl.mouseWheel;
	}
...
kha_SystemImpl.mouseDown = function(event) {
	...
	if(event.which == 1) {
		...
		kha_SystemImpl.mouse.sendDownEvent(2,kha_SystemImpl.mouseX,kha_SystemImpl.mouseY);
...
kha_SystemImpl.mouseUp = function(event) {
	...
	if(event.which == 1) {
		if(kha_SystemImpl.leftMouseCtrlDown) {
			kha_SystemImpl.mouse.sendUpEvent(1,kha_SystemImpl.mouseX,kha_SystemImpl.mouseY);
		} else {
			kha_SystemImpl.mouse.sendUpEvent(0,kha_SystemImpl.mouseX,kha_SystemImpl.mouseY);
		}
		kha_SystemImpl.leftMouseCtrlDown = false;
	} else if(event.which == 2) {
		kha_SystemImpl.mouse.sendUpEvent(2,kha_SystemImpl.mouseX,kha_SystemImpl.mouseY);
	} else if(event.which == 3) {
		kha_SystemImpl.mouse.sendUpEvent(1,kha_SystemImpl.mouseX,kha_SystemImpl.mouseY);
	}
};
...
kha_WebGLImage.prototype = $extend(kha_Image.prototype,{
	...
	,createTexture: function() {
		...
		if(this.renderTarget) {
			...
			kha_SystemImpl.gl.texImage2D(kha_SystemImpl.gl.TEXTURE_2D,0,kha_SystemImpl.gl.RGBA,kha_SystemImpl.gl.RGBA,this.format == kha_graphics4_TextureFormat.RGBA128 ? kha_SystemImpl.gl.FLOAT : kha_SystemImpl.gl.UNSIGNED_BYTE,this.image);
		}
		kha_SystemImpl.gl.bindTexture(kha_SystemImpl.gl.TEXTURE_2D,null);
	}
	,set: function(stage) {
	...
	,lock: function(level) {
		...
		this.bytes = new haxe_io_Bytes(new ArrayBuffer(this.format == kha_graphics4_TextureFormat.RGBA32 ? 4 * this.get_width() * this.get_height() : this.format == kha_graphics4_TextureFormat.RGBA128 ? 16 * this.get_width() * this.get_height() : this.get_width() * this.get_height()));
		return this.bytes;
	}
	,unlock: function() {
		if(kha_SystemImpl.gl != null) {
...
kha_audio2_Audio1._init = function() {
	...
	var this3 = new Array(512);
	kha_audio2_Audio1.sampleCache1 = this3;
	var this4 = new Array(512);
...
kha_audio2_Audio1._mix = function(samples,buffer) {
	...
	while(_g3 < _g11.length) {
		...
		while(_g31 < _g21) {
			...
			var val = kha_audio2_Audio1.sampleCache1[i2] * channel.get_volume();
			_g5[_g4] = _g5[_g4] + val;
		}
	}
	var _g12 = 0;
...
kha_graphics4_ImageShaderPainter.prototype = {
	...
	,drawImage: function(img,bottomleftx,bottomlefty,topleftx,toplefty,toprightx,toprighty,bottomrightx,bottomrighty,opacity,color) {
		...
		this.rectVertices[baseIndex + 6] = g;
		this.rectVertices[baseIndex + 7] = b;
		this.rectVertices[baseIndex + 8] = opacity;
		this.rectVertices[baseIndex + 14] = r;
		this.rectVertices[baseIndex + 15] = g;
		this.rectVertices[baseIndex + 16] = b;
		this.rectVertices[baseIndex + 17] = opacity;
		this.rectVertices[baseIndex + 23] = r;
		this.rectVertices[baseIndex + 24] = g;
		this.rectVertices[baseIndex + 25] = b;
		this.rectVertices[baseIndex + 26] = opacity;
		this.rectVertices[baseIndex + 32] = r;
		this.rectVertices[baseIndex + 33] = g;
		this.rectVertices[baseIndex + 34] = b;
		this.rectVertices[baseIndex + 35] = opacity;
...
kha_graphics4_ColoredShaderPainter.prototype = {
	...
	,setRectColors: function(color) {
		...
		this.rectVertices[baseIndex + 6] = kha__$Color_Color_$Impl_$.get_Ab(color) * 0.00392156862745098;
		...
		this.rectVertices[baseIndex + 13] = kha__$Color_Color_$Impl_$.get_Ab(color) * 0.00392156862745098;
		...
		this.rectVertices[baseIndex + 20] = kha__$Color_Color_$Impl_$.get_Ab(color) * 0.00392156862745098;
		...
		this.rectVertices[baseIndex + 27] = kha__$Color_Color_$Impl_$.get_Ab(color) * 0.00392156862745098;
	}
	...
	,setTriColors: function(color) {
		...
		this.triangleVertices[baseIndex + 6] = kha__$Color_Color_$Impl_$.get_Ab(color) * 0.00392156862745098;
		...
		this.triangleVertices[baseIndex + 13] = kha__$Color_Color_$Impl_$.get_Ab(color) * 0.00392156862745098;
		...
		this.triangleVertices[baseIndex + 20] = kha__$Color_Color_$Impl_$.get_Ab(color) * 0.00392156862745098;
	}
...
kha_graphics4_TextShaderPainter.prototype = {
	...
	,setRectColors: function(color) {
		...
		this.rectVertices[baseIndex + 8] = kha__$Color_Color_$Impl_$.get_Ab(color) * 0.00392156862745098;
		...
		this.rectVertices[baseIndex + 17] = kha__$Color_Color_$Impl_$.get_Ab(color) * 0.00392156862745098;
		...
		this.rectVertices[baseIndex + 26] = kha__$Color_Color_$Impl_$.get_Ab(color) * 0.00392156862745098;
		...
		this.rectVertices[baseIndex + 35] = kha__$Color_Color_$Impl_$.get_Ab(color) * 0.00392156862745098;
	}
	,drawBuffer: function() {
		this.rectVertexBuffer.unlock();
		this.g.setVertexBuffer(this.rectVertexBuffer);
...
kha_graphics4_IndexBuffer.prototype = {
	...
	,unlock: function() {
		...
		var tmp = this.usage == kha_graphics4_Usage.DynamicUsage ? kha_SystemImpl.gl.DYNAMIC_DRAW : kha_SystemImpl.gl.STATIC_DRAW;
		kha_SystemImpl.gl.bufferData(kha_SystemImpl.gl.ELEMENT_ARRAY_BUFFER,new Uint16Array(this.data),tmp);
	}
	,set: function() {
		kha_SystemImpl.gl.bindBuffer(kha_SystemImpl.gl.ELEMENT_ARRAY_BUFFER,this.buffer);
	}
...
kha_graphics4_PipelineState.prototype = $extend(kha_graphics4_PipelineStateBase.prototype,{
	compile: function() {
		...
		if(!kha_SystemImpl.gl.getProgramParameter(this.program,kha_SystemImpl.gl.LINK_STATUS)) {
	...
	,compileShader: function(shader) {
		...
		if(!kha_SystemImpl.gl.getShaderParameter(s,kha_SystemImpl.gl.COMPILE_STATUS)) {
...
kha_input_Mouse.prototype = $extend(kha_network_Controller.prototype,{
	...
	,remove: function(downListener,upListener,moveListener,wheelListener) {
		...
		if(wheelListener != null) {
			HxOverrides.remove(this.wheelListeners,wheelListener);
		}
	}
	,lock: function() {
	}
	...
	,sendDownEvent: function(button,x,y) {
		if(kha_network_Session.the() != null) {
			var bytes = new haxe_io_Bytes(new ArrayBuffer(38));
			bytes.b[0] = 2;
			bytes.setInt32(1,this._id());
			bytes.setDouble(5,kha_Scheduler.realTime());
			bytes.setInt32(13,kha_System.get_pixelWidth());
	...
	,sendWheelEvent: function(delta) {
		if(kha_network_Session.the() != null) {
			var bytes = new haxe_io_Bytes(new ArrayBuffer(30));
			bytes.b[0] = 2;
			bytes.setInt32(1,this._id());
			bytes.setDouble(5,kha_Scheduler.realTime());
			bytes.setInt32(13,kha_System.get_pixelWidth());
...
kha_js_CanvasGraphics.prototype = $extend(kha_graphics2_Graphics.prototype,{
	...
	,clear: function(color) {
		...
		var tmp = "rgba(" + kha__$Color_Color_$Impl_$.get_Rb(color) + "," + kha__$Color_Color_$Impl_$.get_Gb(color) + "," + kha__$Color_Color_$Impl_$.get_Bb(color) + "," + kha__$Color_Color_$Impl_$.get_Ab(color) * 0.00392156862745098;
		this.canvas.strokeStyle = tmp + ")";
		var tmp1 = "rgba(" + kha__$Color_Color_$Impl_$.get_Rb(color) + "," + kha__$Color_Color_$Impl_$.get_Gb(color) + "," + kha__$Color_Color_$Impl_$.get_Bb(color) + "," + kha__$Color_Color_$Impl_$.get_Ab(color) * 0.00392156862745098;
		this.canvas.fillStyle = tmp1 + ")";
	...
	,fillRect: function(x,y,width,height) {
		...
		var tmp1 = kha__$Color_Color_$Impl_$.get_Ab(this.myColor) * 0.00392156862745098;
...
var kha_js_WebAudioSound = function(filename,done) {
	...
	request.onload = function() {
		...
		if(header.channel == 1) {
			...
			while(_g1 < _g) {
				var i = _g1++;
				_gthis.data[i * 2] = soundBytes.getFloat(i * 4);
				_gthis.data[i * 2 + 1] = soundBytes.getFloat(i * 4);
			}
		} else {
			...
			while(_g11 < _g2) {
				var i1 = _g11++;
				_gthis.data[i1] = soundBytes.getFloat(i1 * 4);
			}
		}
		done(_gthis);
	};
...
kha_js_graphics4_Graphics.prototype = {
	begin: function(additionalRenderTargets) {
		...
		if(this.renderTarget == null) {
			...
			if(additionalRenderTargets != null) {
				kha_SystemImpl.gl.framebufferTexture2D(kha_SystemImpl.gl.FRAMEBUFFER,kha_SystemImpl.drawBuffers.COLOR_ATTACHMENT0_WEBGL,kha_SystemImpl.gl.TEXTURE_2D,this.renderTarget.texture,0);
				var _g1 = 0;
				var _g = additionalRenderTargets.length;
				while(_g1 < _g) {
					var i = _g1++;
					kha_SystemImpl.gl.framebufferTexture2D(kha_SystemImpl.gl.FRAMEBUFFER,kha_SystemImpl.drawBuffers.COLOR_ATTACHMENT0_WEBGL + i + 1,kha_SystemImpl.gl.TEXTURE_2D,(js_Boot.__cast(additionalRenderTargets[i] , kha_WebGLImage)).texture,0);
				}
	...
	,clear: function(color,depth,stencil) {
		...
		if(stencil != null) {
			clearMask |= kha_SystemImpl.gl.STENCIL_BUFFER_BIT;
		}
	...
	,setBlendingMode: function(source,destination) {
		if(source == kha_graphics4_BlendingOperation.BlendOne && destination == kha_graphics4_BlendingOperation.BlendZero) {
			kha_SystemImpl.gl.disable(kha_SystemImpl.gl.BLEND);
		} else {
			kha_SystemImpl.gl.enable(kha_SystemImpl.gl.BLEND);
	...
	,scissor: function(x,y,width,height) {
		...
		var h = this.renderTarget == null ? kha_System.get_pixelHeight() : this.renderTarget.get_height();
	...
	,drawIndexedVerticesInstanced: function(instanceCount,start,count) {
		...
		if(this.instancedRenderingAvailable()) {
			this.instancedExtension.drawElementsInstancedANGLE(kha_SystemImpl.gl.TRIANGLES,count == -1 ? this.indicesCount : count,kha_SystemImpl.gl.UNSIGNED_SHORT,start * 2,instanceCount);
		}
	}
